...
public class dtoCustomer {
    ...
    @SerializedName("life_time_orders")
    @Expose
    private Integer lifeTimeOrders;
    @SerializedName("life_time_orders_total")
    @Expose
    private String lifeTimeOrdersTotal;
    @SerializedName("orders_average")
    @Expose
    private String ordersAverage;
    @SerializedName("addresses")
    @Expose
    private List<dtoAddress> addresses = null;
    @SerializedName("customer_coupons")
    @Expose
    private List<Object> customerCoupons = null;
    ...
    public Integer getLifeTimeOrders() {
        return lifeTimeOrders;
    }

    public void setLifeTimeOrders(Integer lifeTimeOrders) {
        this.lifeTimeOrders = lifeTimeOrders;
    }

    public String getLifeTimeOrdersTotal() {
        return lifeTimeOrdersTotal;
    }

    public void setLifeTimeOrdersTotal(String lifeTimeOrdersTotal) {
        this.lifeTimeOrdersTotal = lifeTimeOrdersTotal;
    }

    public String getOrdersAverage() {
        return ordersAverage;
    }

    public void setOrdersAverage(String ordersAverage) {
        this.ordersAverage = ordersAverage;
    }
    ...
    public List<Object> getCustomerCoupons() {
        return customerCoupons;
    }

    public void setCustomerCoupons(List<Object> customerCoupons) {
